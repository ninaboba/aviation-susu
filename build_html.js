      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="glass-panel p-6 rounded-2xl border border-cockpit-border space-y-5">
            ...
            <!-- Slider -->
            <div class="space-y-2">
              <input type="range" id="countSlider" min="5" max="200" step="5" value="20" oninput="app.updateQuestionCount(this.value)" class="w-full h-2 bg-cockpit-800 rounded-lg appearance-none cursor-pointer accent-cyan-400">
              <div class="flex justify-between text-[11px] font-mono text-slate-400">
                <span>5 ข้อ</span>
                <span>50 ข้อ</span>
                <span>100 ข้อ</span>
                <span id="maxAvailableLabel">200 ข้อ</span>
              </div>
            </div>
            ...
            <div class="flex flex-wrap gap-2 pt-1">
              ...
              <button type="button" onclick="app.setCountPreset(200)" class="px-3 py-1 text-xs rounded-lg bg-cockpit-850 hover:bg-cockpit-800 border border-cockpit-border text-slate-300 font-mono">All (ทั้งหมด)</button>
            </div>
          </div>
